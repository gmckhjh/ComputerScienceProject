...
"""
Concrete implementation of the SingleModel class - creates 2 stack Gated Recurrent Unit model and compiles it 
based on the parameter values
"""


class GruTwoStack(TwoStackModel):
    ...
    def create_model(self, num_inputs1, shape, num_inputs2) -> Sequential:
        ...
        self.model.add(GRU(num_inputs1, return_sequences=True, input_shape=shape))
        self.model.add(Dropout(0.1))
        self.model.add(GRU(num_inputs2))
        self.model.add(Dropout(0.1))
