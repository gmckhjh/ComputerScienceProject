...
"""
Concrete implementation of the SingleModel class - creates a single layer BiDirectional model and compiles it based on
the parameter values
"""


class BiDirSingle(SingleModel):
    ...
    def create_model(self, num_inputs, shape) -> Sequential:
        ...
        self.model.add(Bidirectional(LSTM(num_inputs, input_shape=shape)))
