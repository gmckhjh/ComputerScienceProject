...
"""
Financial news scraper, uses beautiful soup to scrape finviz website for data about a ticker, ignoring headlines without
mention of the ticker or short name of the company. Returns data for sentiment analysis. 
"""

finviz_url = "https://finviz.com/quote.ashx?t="

# Scrapes finviz webite for data about a ticker
def scrape_finviz(ticker: str):
    ...
    try:
        ...
        raise Exception("Ticker couldn't be found")
